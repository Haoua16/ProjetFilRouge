...
class GesCourrierController extends Controller
{
    //
    public function viewForm()
    {
        return view ('gescourriers.gescourrierRegister');
    }


    public function registerGes(Request $request)
    {
       ...
       $verification = $request->validate(
           ...
           if($verification)
           {
               ...
               if($user)
               {
                $gescourrier = GesCourrier::create(
                    [
                        'nom' => $request['nom'],
                        'prenom' => $request['prenom'],
                        'telephone' => $request['telephone'],
