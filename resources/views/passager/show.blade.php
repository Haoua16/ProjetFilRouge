      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-white bg-primary border-primary">
            <h4 class="my-0 fw-normal">Passager: {{$passagers->nom}}</h4>
          </div>
          <div class="card-body">
            <ul class="list-unstyled mt-3 mb-4">
              <li>Nom: {{$passagers->nom}}</li>
              <li>Prenom: {{$passagers->prenom}}</li>
              <li>Numéro de téléphone: {{$passagers->numerotelephone}}</li>
              <li>Nombre de place: {{$passagers->nombreplace}}</li>
            </ul>
          </div>
        </div>
      </div>
