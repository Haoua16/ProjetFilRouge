...
@if(session()->get('success'))
  ...
  <div class="titre"  style="margin-top: -7px; font-size: 150%;">Mes Voyages</div></br>
  ...
  @foreach($reservations as $reservations)
    <tr>
       ...
       <!-- <td>{{$reservations->date}}</td> -->
        ...
        <!-- <td> -->
        <td>
            <a href="{{ route('reservation.edit', $reservations->id)}}" class="btn btn-success btn-sm">Edit</a>
        </td>
        <!-- <td>
