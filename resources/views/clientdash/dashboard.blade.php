        ...
        <ul class="navbar-nav mr-lg-2">
          ...
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              ...
              <p class="mb-0">Dashboard_Client</p>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav navbar-nav-right">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
              ...
              <span class="menu-title">Mes Voyages</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/clientvoyage">
                <i class="typcn typcn-document-text menu-icon"></i>
              <span class="menu-title">Réserver</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/clientreservation">
                <i class="typcn typcn-document-text menu-icon"></i>
              <span class="menu-title">Voyages en Cours</span></a>
            </li>
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="/voyage/create">Programmer</a></li>
              </ul>
            </div>
          
          <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="passager/create">Réserver</a></li>
              </ul>
            </div>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <i class="typcn typcn-document-text menu-icon"></i>
              <span class="menu-title">Plaintes</span></a>
            </li>
