      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-white bg-primary border-primary">
            <h4 class="my-0 fw-normal">Bagage: {{$bagages->nature}}</h4>
          </div>
          <div class="card-body">
            <ul class="list-unstyled mt-3 mb-4">
              <li>Nature du bagage: {{$bagages->nature}}</li>
              <li>Nombre du bagage: {{$bagages->nombrebagage}}</li>
              <li>Montant payé: {{$bagages->montantpaye}}</li>
            </ul>
          </div>
        </div>
      </div>
