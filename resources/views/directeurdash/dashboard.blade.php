...
<head>
    ...
    <title style="font-size: 18px; font-family:georgia;">Dashboard_Directeur</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3" style="font-family:georgia;">SAINGUAI-BANA</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span style="font-size: 18px; font-family:georgia;" >Dashboard_Directeur</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Enrégistrer</strong></span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Enrégistrer</h6>
                        <a class="collapse-item" href="chauffeur/create">Chauffeur</a>
                        <a class="collapse-item" href="bus/create">Bus</a>
                    </div>
                </div>
            </li>

            <!-- <li class="nav-item">
                <a class="nav-link" href="/directeurvoyage">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <!-- <i class="fas fa-fw fa-wrench"></i> -->
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Superviser</strong></span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Voir les listes</h6>
                        <a class="collapse-item" href="/directeurlistevoyage">Voyage</a>
                        <a class="collapse-item" href="/directeurreservation">Réservation</a>
                        <a class="collapse-item" href="/directeurbagage">Bagage</a>
                        <a class="collapse-item" href="/directeurcourrier">Courriers</a>
                        <a class="collapse-item" href="/chauffeur">Chauffeur</a>
                        <a class="collapse-item" href="/bus">Bus</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/directeurreserv1">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Mes Voyages</strong></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/plainte">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Plaintes</strong></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/rembourssement">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Se déconnecter</strong></span></a>
            </li>
