        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="bagage/create">Bagages</a></li>
              </ul>
            </div>
          
          <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="courrier/create">Courriers</a></li>
              </ul>
            </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/bagage">Bagages</a></li>
                <li class="nav-item"> <a class="nav-link" href="/courrier">Courriers</a></li>
                <li class="nav-item"> <a class="nav-link" href="/gescourrierlistevoyage">Voyages</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <i class="fa fa-money"></i>
                    <span class="menu-title" style="margin-left: 11%;">Rembourssement</span></a>
            </li>
