...
<head>
    ...
    <title style="font-family:georgia;">Dashboard_Gestionnaire-Courrier</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span style="font-size: 18px; font-family:trebruchet ms;">Dashboard_Gestionnaire-Courriers</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/gescourrierlistevoyage">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Liste Voyages</strong></span></a>
            </li>

            <!-- <li class="nav-item">
                <a class="nav-link" href="/gescourriervoyage">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Réservations</strong></span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/gescourrierreserv1">
