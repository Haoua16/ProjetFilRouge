  ...
  <h3 class="text-center">Liste des Réservations</h3></br>
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- <td>< href="{{ route('reservation.edit', $reservations->id)}}" class="btn btn-primary">Modifier</a></td>
            <td>
            ...
            <!-- <td>
            <a href="{{ route('comptable.reservation', $reservations->id)}}" class="btn btn-primary">Détails</a>
            </td> -->
        </tr>
        @endforeach
    </tbody>
