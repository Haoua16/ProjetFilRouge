        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.html">
                    ...
                    <span style="font-size: 18px; font-family:georgia;" >Dashboard_Caissier</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="voyage/create">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Programmer Voyage</strong></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/voyage">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Liste Voyages</strong></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/reservation">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Liste Réservations</strong></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/administrateurvoyage">
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Réserver</strong></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/administrateurreserv1">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <span style="font-size: 18px; font-family:trebruchet ms;"><strong>Pages</strong></span>
                </a>
            ...
            <li class="nav-item">
              ...
              <!-- Nav Item - Pages Collapse Menu -->
              <li class="nav-item">
                <a class="nav-link collapsed" href="/paramètre" data-toggle="collapse" data-target="#collapseTwo"
